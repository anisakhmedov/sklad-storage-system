 ...
 * выданного конкретному арендатору и подлежащего возврату — отдельный ПАРАЛЛЕЛЬНЫЙ учёт от
 * models/BoxLedgerEntry.ts (ящики под товар клиента, с расчётом стоимости за ящик): здесь нет
 * ставки/стоимости, это просто складской инструмент, временно переданный клиенту. Баланс по
